...
object LanguageHelper {
    ...
    private val stringMap = mapOf(
        ...
        "wishlist" to Trans("Wishlist", "উইশলিস্ট"),
        "wishlist_items" to Trans("Wishlist Items", "উইশলিস্ট আইটেমসমূহ"),
        "add_to_wishlist" to Trans("Add to Wishlist", "উইশলিস্টে যোগ করুন"),
        "edit_wishlist_item" to Trans("Edit Wishlist Item", "উইশলিস্ট সম্পাদনা"),
        "item_name" to Trans("Item Name", "আইটেমের নাম"),
        "estimated_cost" to Trans("Estimated Cost", "আনুমানিক মূল্য"),
        "planned_timeline" to Trans("Planning Timeline", "পরিকল্পনার সময়কাল"),
        "next_month" to Trans("Next Month", "পরবর্তী মাস"),
        "specific_month" to Trans("Specific Month", "নির্দিষ্ট মাস"),
        "save_up_goal" to Trans("Save Up (Savings Goal)", "সঞ্চয় লক্ষ্য হিসেবে জমা"),
        "someday_maybe" to Trans("Someday / Unscheduled", "ভবিষ্যতে / অনির্ধারিত"),
        "priority" to Trans("Priority", "অগ্রাধিকার"),
        "priority_high" to Trans("High Priority", "উচ্চ অগ্রাধিকার"),
        "priority_medium" to Trans("Medium Priority", "মাঝারি অগ্রাধিকার"),
        "priority_low" to Trans("Low / Someday", "সাধারণ / কম অগ্রাধিকার"),
        "add_to_budget" to Trans("Add to Budget", "বাজেটে যুক্ত করুন"),
        "add_to_month_budget" to Trans("Include in Month Budget", "মাসিক বাজেটে যুক্ত করুন"),
        "added_to_budget" to Trans("Added to Budget", "বাজেটে যুক্ত"),
        "convert_to_goal" to Trans("Convert to Savings Goal", "সঞ্চয় লক্ষ্যে রূপান্তর"),
        "mark_purchased" to Trans("Mark Purchased", "ক্রয় সম্পন্ন"),
        "record_purchase" to Trans("Record Purchase", "ক্রয় রেকর্ড করুন"),
        "wishlist_reminder" to Trans("Wishlist items planned for this month", "এই মাসে কেনার পরিকল্পনার উইশলিস্ট"),
        "no_wishlist_items" to Trans("No items in wishlist yet. Tap + to add items you plan to buy!", "উইশলিস্টে কোনো আইটেম নেই। কিনতে চান এমন আইটেম যুক্ত করতে + চাপুন!"),
        "wishlist_total_value" to Trans("Total Wishlist", "মোট উইশলিস্ট"),
        "planned_next_month_val" to Trans("Next Month", "পরবর্তী মাস"),
        "in_goals_val" to Trans("In Savings Goals", "সঞ্চয় লক্ষ্যে"),
        "product_link" to Trans("Product Link / Store URL", "পণ্যের লিংক / URL"),
        ...
        "add_goal" to Trans("Add Goal", "লক্ষ্য যোগ"),
        "add_savings_goal" to Trans("Add Goal", "লক্ষ্য যোগ"),
        "dialog_add_goal_title" to Trans("Add Goal", "নতুন লক্ষ্য যুক্ত করুন"),
        "edit_savings_goal" to Trans("Edit Goal", "লক্ষ্য সম্পাদনা"),
        ...
        "select_favorite_accounts" to Trans("Favorite Account Card Settings", "পছন্দের অ্যাকাউন্ট কার্ড সেটিংস"),
        "favorite_accounts_settings" to Trans("Favorite Account Card Settings", "পছন্দের অ্যাকাউন্ট কার্ড সেটিংস"),
        "favorite_account_card_settings" to Trans("Favorite Account Card Settings", "পছন্দের অ্যাকাউন্ট কার্ড সেটিংস"),
        ...
        "manually_added" to Trans("Manually Added", "ম্যানুয়ালি যুক্ত"),
        "manually_added_desc" to Trans("Accounts you select yourself to display on the card.", "যেসব অ্যাকাউন্ট আপনি নিজে নির্বাচন করবেন।"),
        "auto_added" to Trans("Auto Added", "স্বয়ংক্রিয় যুক্ত"),
        "auto_added_desc" to Trans("Automatically selected accounts based on recent activity and non-zero balance.", "সাম্প্রতিক লেনদেন ও অবশিষ্ট ব্যালেন্সের ভিত্তিতে স্বয়ংক্রিয়ভাবে নির্বাচিত হিসাব।"),
        "auto_added_recent" to Trans("Auto Added (Recent Activity)", "স্বয়ংক্রিয় (সাম্প্রতিক লেনদেন)"),
        "auto_add_rules_title" to Trans("Auto Add Rules", "স্বয়ংক্রিয় যুক্ত করার নিয়মাবলী"),
        "auto_add_rule_activity" to Trans("Automatically added when an account has recent activity.", "সাম্প্রতিক লেনদেন সম্পন্ন হলে অ্যাকাউন্ট স্বয়ংক্রিয়ভাবে যুক্ত হয়।"),
        "auto_add_rule_balance" to Trans("Kept in the card while it has a non-zero balance (positive or negative).", "ব্যালেন্স ০ না হওয়া পর্যন্ত (ধনাত্মক বা ঋণাত্মক) কার্ডে প্রদর্শিত থাকে।"),
        "auto_add_rule_zero" to Trans("Automatically removed when its balance becomes 0.", "ব্যালেন্স ০ হলে স্বয়ংক্রিয়ভাবে কার্ড থেকে বাদ দেওয়া হয়।"),
        "auto_add_rule_excluded" to Trans("Accounts excluded from Accounts tab or calculated as 0 balance are never shown.", "হিসাব ট্যাব থেকে বাদ দেওয়া বা কার্যকর ব্যালেন্স ০ থাকা অ্যাকাউন্ট প্রদর্শিত হবে না।"),
        "auto_add_rule_independent" to Trans("Manual selection remains completely independent from the auto-added list.", "ম্যানুয়াল নির্বাচন সম্পূর্ণ স্বাধীনভাবে কাজ করে।"),
        "no_auto_accounts_hint" to Trans("No accounts are automatically added right now. Accounts with recent activity and a non-zero balance will appear here automatically.", "বর্তমানে কোনো স্বয়ংক্রিয় হিসাব যুক্ত নেই। সাম্প্রতিক লেনদেন ও ব্যালেন্স থাকলে স্বয়ংক্রিয়ভাবে এখানে যুক্ত হবে।"),
        "add_to_manual" to Trans("Add to Manual", "ম্যানুয়ালে যোগ করুন"),
        "added_to_manual" to Trans("Added to Manual", "ম্যানুয়ালে যুক্ত"),
        "manual_favorite" to Trans("Manual Favorite", "ম্যানুয়াল পছন্দ"),
        "drag_to_reorder" to Trans("Drag & Reorder", "টেনে সাজান"),
        "drag_reorder_hint" to Trans("Drag ☰ or use ▲/▼ to order accounts", "টেনে অথবা ▲/▼ চেপে ক্রমানুসারে সাজান"),
        "sort_alphabetically" to Trans("Sort A-Z", "বর্ণানুক্রমে"),
        "browse_select" to Trans("Select Accounts", "হিসাব নির্বাচন"),
        "move_up" to Trans("Move Up", "উপরে নিন"),
        "move_down" to Trans("Move Down", "নিচে নিন"),
        "remove" to Trans("Remove", "বাদ দিন"),
        "no_manual_favorites_hint" to Trans("No favorite accounts selected yet. Tap 'Select Accounts' to choose.", "কোনো পছন্দের হিসাব নির্বাচিত নেই। 'হিসাব নির্বাচন' চেপে যোগ করুন।"),
        ...
        "wishlist" to Trans("Wishlist", "ইচ্ছেতালিকা"),
        "add_wishlist_item" to Trans("Add Wishlist Item", "ইচ্ছেতালিকায় যোগ করুন"),
        "edit_wishlist_item" to Trans("Edit Wishlist Item", "ইচ্ছেতালিকা সম্পাদনা"),
        "wishlist_empty" to Trans("No wishlist items yet", "কোনো ইচ্ছেতালিকা আইটেম নেই"),
        "wishlist_empty_hint" to Trans("Plan future purchases, next month wishes, or link them to savings goals.", "ভবিষ্যতের কেনাকাটা, আগামী মাসের ইচ্ছা পরিকল্পনা করুন বা সঞ্চয় লক্ষ্যের সাথে যুক্ত করুন।"),
        "wishlist_summary" to Trans("Wishlist Summary", "ইচ্ছেতালিকা সারসংক্ষেপ"),
        "target_next_month" to Trans("Next Month Budget", "আগামী মাসের বাজেট"),
        "target_specific_month" to Trans("Specific Month", "নির্দিষ্ট মাস"),
        "target_savings_goal" to Trans("Savings Goal", "সঞ্চয় লক্ষ্য"),
        "target_someday" to Trans("Someday / Idea", "ভবিষ্যতে কোনো এক সময়"),
        "priority_high" to Trans("High Priority", "উচ্চ অগ্রাধিকার"),
        "priority_medium" to Trans("Medium Priority", "মাঝারি অগ্রাধিকার"),
        "priority_low" to Trans("Low Priority", "স্বাভাবিক / কম অগ্রাধিকার"),
        "mark_purchased" to Trans("Mark as Purchased", "ক্রয় সম্পন্ন চিহ্নিত করুন"),
        "mark_unpurchased" to Trans("Mark as Pending", "অসম্পন্ন চিহ্নিত করুন"),
        "record_as_expense" to Trans("Record as Expense", "ব্যয় হিসেবে লিপিবদ্ধ করুন"),
        "convert_to_goal" to Trans("Convert to Savings Goal", "সঞ্চয় লক্ষ্যে রূপান্তর"),
        "add_to_next_month_budget" to Trans("Add to Next Month Budget", "আগামী মাসের বাজেটে যোগ করুন"),
        "added_to_budget" to Trans("Added to Budget", "বাজেটে অন্তর্ভুক্ত"),
        "estimated_price" to Trans("Estimated Price", "আনুমানিক মূল্য"),
        "item_name" to Trans("Item / Wish Name", "আইটেম / ইচ্ছার নাম"),
        "wishlist_tab_active" to Trans("Active", "সক্রিয়"),
        "wishlist_tab_next_month" to Trans("Next Month", "আগামী মাস"),
        "wishlist_tab_planned" to Trans("Planned", "পরিকল্পিত"),
        "wishlist_tab_goals" to Trans("Goals", "লক্ষ্য"),
        "wishlist_tab_purchased" to Trans("Purchased", "ক্রয়কৃত"),
        "wishlist_tab_all" to Trans("All", "সকল"),
